        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 4, new DateTime(2025, 1, 5, 21, 58, 18, 56, DateTimeKind.Local).AddTicks(5579), false, "Kadın", 2, 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2025, 1, 5, 21, 58, 18, 62, DateTimeKind.Local).AddTicks(9424), "Lambadaki gül laudantium nesciunt çıktılar.", false, "Sokaklarda." },
                    ...
                    { 3, 4, new DateTime(2025, 1, 5, 21, 58, 18, 62, DateTimeKind.Local).AddTicks(9538), "Consequuntur sokaklarda vel çakıl.", true, "Orta." }
                });
